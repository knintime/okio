...
import static com.rc.script.okio.Util.checkOffsetAndCount;
...
//  @IgnoreJRERequirement
  ...
  private void deflate(boolean syncFlush) throws IOException {
    ...
    while (true) {
      ...
      // deflate（）的4参数重载在Java 1.7之前不存在于RI中，自2.3开始在Android上公开（尽管使用@hide）
      // @hide标记意味着这段代码不会针对Android 2.3 SDK进行编译，但它在那里运行良好
      // TODO 注意deflate 4参数方法的使用版本
